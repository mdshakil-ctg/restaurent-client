...
const Reservation = lazy(()=> import('./../Pages/Dashboard/Reservation/Reservation'))
...
const Mybooking = lazy(()=> import('./../Pages/Dashboard/Mybooking/Mybooking'))
const AllUsers = lazy(()=> import('../Pages/Dashboard/Admin/AllUsers/AllUsers'))
const AddItem = lazy(()=> import('../components/AddItem/AddItem'))
const ManageItems = lazy(()=> import('../Pages/Dashboard/Admin/AllUsers/ManageItems/ManageItems'))
const PaymentSuccess = lazy(()=> import('../Pages/Dashboard/Payment/PaymentSuccess'))
const PaymentFailed = lazy(()=> import('../Pages/Dashboard/Payment/PaymentFailed'))
...
const UpdateItems = lazy(()=> import('../Pages/Dashboard/Admin/UpdateItems/UpdateItems'))
const ManageBookings = lazy(()=> import('../Pages/Dashboard/Admin/ManageBookings/ManageBookings'))
