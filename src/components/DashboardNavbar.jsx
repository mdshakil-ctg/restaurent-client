...
const DashboardNavbar = () => {
    return (
        <div className="bg-[#1C1C1C]  flex justify-between items-center px-3 py-3 md:px-6 md:py-3 ">
         <div className="relative">
          {/* <input className="border bg-[#16212A] w-full " type="text" name="" id="" /> */}
          <input className="w-[120px] h-[30px] md:w-[300px] md:h-[30px] pr-10 pl-4 m-0 bg-black font-medium placeholder:text-sm focus:outline-none focus:border-b  focus:border-b-yellow-300 " type="text" name="" id="" placeholder=""  />
